  ...
  return (
    ...
    >
      ...
      <div className="w-full max-w-6xl flex flex-col md:flex-row gap-10">
          ...
          <div className="flex flex-col gap-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-white">mahdyar.karimi@example.com</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-white">+81 XX-XXXX-XXXX</p>
              </div>
            </div>
        ...
        >
          <form onSubmit={handleSubmit} className="bg-[#0A0A1B] p-8 rounded-xl border border-[#2A0E61]">
            <div className="mb-6">
